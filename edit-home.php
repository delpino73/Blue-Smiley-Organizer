...
if (isset($_REQUEST['save'])) {
	...
	$base_instance->query("UPDATE {$base_instance->entity['HOME']['MAIN']} SET title='$title',element1='$element1',element2='$element2',element3='$element3',element4='$element4',element5='$element5',element6='$element6',element7='$element7',element8='$element8',element9='$element9',element10='$element10',element11='$element11',element12='$element12' WHERE ID='$home_id' AND user='$userid'");

	$base_instance->show_message('Home updated','<a href="edit-home.php?home_id='.$home_id.'">[Edit Home]</a> &nbsp;&nbsp;&nbsp; <a href="add-home.php">[Add Home]</a> &nbsp;&nbsp;&nbsp; <a href="home.php?home_id='.$home_id.'">[Show Homepage]</a><p><a href="show-home.php">[Show all Homepages]</a>
