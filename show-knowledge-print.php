...
$order_col=isset($_COOKIE['oc_know']) ? $_COOKIE['oc_know'] : 'datetime';
$order_type=isset($_COOKIE['ot_know']) ? $_COOKIE['ot_know'] : 'DESC';

#

$data=$base_instance->get_data("SELECT * FROM {$base_instance->entity['KNOWLEDGE']['MAIN']} WHERE user='$userid'$where ORDER BY $order_col $order_type");
